...
//app.get("/lecturadatos", paginaAdmin);
app.get("/administrador", paginaAdmin);
app.get("/usuario", paginaUsuario);

app.get("/lecturadatos", fLerDatos);
app.get("/lecturausuarios", fLeerUsuarios);
app.get("/usuario", fLeerUsuarios)

app.post('/registrar',  registroUsuario);
//app.get("/administrador", fLerDatos);
